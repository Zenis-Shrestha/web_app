...
class BuildingRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'owner_gender.required_if' => 'Owner Gender is required',
            ...
            'road_code.required_if' => 'Road Code is required.',
            ...
            'construction_year.required_if' => 'Building Construction Date is required.',
            //lic
            'low_income_hh.required_if' => 'Is Low Income House is required.',

            'lic_id.required_if' => 'LIC Name is required.',
            //Water Source Information
            'water_source_id.required_if' => "Main Drinking Water Source is required",
            'watersupply_pipe_code.required_if' => 'Water Supply Pipe Line Code is required',

            //Sanitation System Information
            'toilet_status.required_if' => 'Presence of Toilet is required',
            ...
            'household_served.required_if' => 'Number of Households is required',
            'population_served.required_if' => 'Population of Building is required',
    ...
    public function store()
    {
        ...
        return [
            ...
            'toilet_count' => 'exclude_if:toilet_status,0 |required_if:toilet_status,1|nullable|integer| min:1',
